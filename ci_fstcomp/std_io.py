...
try:
    ...
    logging.critical("Could not import rpnpy.librmn.all (" + str(e) + "), this package is only available through the environment via PYTHONPATH set by doing an . r.load.dot:")
