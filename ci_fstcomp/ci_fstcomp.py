...
def cli():
    ...
    parser.add_argument('--c-cor-thr', type=float, default=.0000001, help='corelation error threshold (default: .0000001)')
    parser.add_argument('--e-max-thr', type=float, default=.0000001, help='relative error threshold (default: .0000001)')
    parser.add_argument('--exclude_meta', type=bool, default=False, help='exclude meta data fields from comparison')
    parser.add_argument('--cmp_number_of_fields', type=bool, default=False, help='compare the number of fields in each file')
    ...
    status = fstcomp(file1=args.a, file2=args.b, exclude_meta=args.exclude_meta, cmp_number_of_fields=args.cmp_number_of_fields, verbose=False, e_max=args.e_max_thr, e_c_cor=args.c_cor_thr)
